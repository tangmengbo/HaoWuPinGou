//
//  FuQiJiaoRehnZhengNewViewController.m
//  JianZhi
//
...
@interface FuQiJiaoRehnZhengNewViewController ()

@end

@implementation FuQiJiaoRehnZhengNewViewController
...
-(void)initTopStepView
{
    ...
    UILabel * step1TipLable = [[UILabel alloc] initWithFrame:CGRectMake(0,step1BottomView.top+step1BottomView.height+8.5*BiLiWidth , WIDTH_PingMu/2, 12*BiLiWidth)];
    ...
    UILabel * step2Lable = [[UILabel alloc] initWithFrame:CGRectMake(WIDTH_PingMu/2+(WIDTH_PingMu/2-22*BiLiWidth)/2, step1Lable.top, 22*BiLiWidth, 22*BiLiWidth)];
    ...
    UILabel * step2TipLable = [[UILabel alloc] initWithFrame:CGRectMake(WIDTH_PingMu/2,step2Lable.top+step2Lable.height+8.5*BiLiWidth , WIDTH_PingMu/2, 12*BiLiWidth)];
...
//    UILabel * chanPinShuLiangLable = [[UILabel alloc] initWithFrame:CGRectMake(11.5*BiLiWidth, lineView1.top+lineView1.height, 100*BiLiWidth, 39.5*BiLiWidth)];
    UILabel * chanPinShuLiangLable = [[UILabel alloc] initWithFrame:CGRectMake(11.5*BiLiWidth, view.top+view.height+45.5*BiLiWidth, 100*BiLiWidth, 39.5*BiLiWidth)];
