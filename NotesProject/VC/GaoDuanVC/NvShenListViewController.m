...
@interface NvShenListViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    int page;
}
...
{
    page = 0;
    [HTTPModel getSanDaGirlList:[[NSDictionary alloc]initWithObjectsAndKeys:@"1",@"type_id",[NSString stringWithFormat:@"%d",page],@"page", nil] callback:^(NSInteger status, id  _Nullable responseObject, NSString * _Nullable msg) {
