...
@interface WaiWeiListViewController ()<UITableViewDelegate,UITableViewDataSource,NewPagedFlowViewDataSource,NewPagedFlowViewDelegate>
{
    int page;
}
