//
//  JiaoSeWeiRenZhengFaTieKouFeiVC.m
//  JianZhi
//
...
@implementation JiaoSeWeiRenZhengFaTieKouFeiVC
...
-(void)nextButtonClick
{
    if (self.publish_post_coin.intValue<=self.yuEStr.intValue) {
        ...
        [HTTPModel sanDaRenZheng:self.info callback:^(NSInteger status, id  _Nullable responseObject, NSString * _Nullable msg) {
