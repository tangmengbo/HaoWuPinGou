...
@implementation MyJieSuo_sanDaJiaoSeCell
...
//        [self.headerImageView addSubview:self.faBuTimeLable];
        ...
        self.diQuLable = [[UILabel alloc] initWithFrame:CGRectMake(self.titleLable.left, self.leiXingLable.top, self.leiXingLable.width, 11*BiLiWidth)];
        ...
        self.fuWuLable = [[UILabel alloc] initWithFrame:CGRectMake(self.titleLable.left, self.diQuLable.top+self.diQuLable.height+16*BiLiWidth, self.leiXingLable.width, 11*BiLiWidth)];
        ...
        self.pingFenLable = [[UILabel alloc] initWithFrame:CGRectMake(self.titleLable.left, self.fuWuLable.top+self.fuWuLable.height+16*BiLiWidth, 51*BiLiWidth, 11*BiLiWidth)];
        ...
        self.xiaoFeiLable = [[UILabel alloc] initWithFrame:CGRectMake(self.titleLable.left, self.pingFenLable.top+self.pingFenLable.height+16*BiLiWidth, self.leiXingLable.width, 11*BiLiWidth)];
