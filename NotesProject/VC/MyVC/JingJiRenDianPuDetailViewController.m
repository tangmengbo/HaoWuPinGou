...
//            [self.headerImageView sd_setImageWithURL:[NSURL URLWithString:[images objectAtIndex:0]]];
        ...
        else if ([NormalUse isValidString:[self.dianPuInfo objectForKey:@"image"]])
        {
           // [self.headerImageView sd_setImageWithURL:[NSURL URLWithString:[self.dianPuInfo objectForKey:@"image"]]];
            [self.headerImageView sd_setImageWithURL:[NSURL URLWithString:[self.dianPuInfo objectForKey:@"image"]] placeholderImage:[UIImage imageNamed:@"header_kong"]];
        ...
        UIImageView * vipImageView = [[UIImageView alloc] initWithFrame:CGRectMake(titleLable.left+titleLable.width+10*BiLiWidth, titleLable.top+(titleLable.height-30*BiLiWidth)/2, 30*BiLiWidth, 30*BiLiWidth)];
