...
@property (nonatomic,assign) float currentWidth;//当前滚动到的图片 宽
@property (nonatomic,assign) float currentHeight;//当前滚动到的图片 高

@property (nonatomic,assign) float normalHeight;//当前未滚动到的图片 高
