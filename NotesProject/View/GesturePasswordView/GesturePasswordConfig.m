...
+ (instancetype)sharedInstance
{
    ...
    dispatch_once(&oneToken, ^{
        ...
        config.centerPointColorNormal = RGBFormUIColor(0xcccccc);//中心圆点的颜色（正常）
        config.lineColorNormal = [UIColor whiteColor];;//线条填充颜色（正常）
        
        config.strokeColorSelected = RGBFormUIColor(0xd7f7eb);//圆弧的填充颜色（选择）
        config.fillColorSelected = RGBFormUIColor(0xd7f7eb);//除中心圆点外 其他部分的填充色（选择）
        config.centerPointColorSelected = RGBFormUIColor(0x35d59b);//中心圆点的颜色（选择）
        config.lineColorSelected = RGBFormUIColor(0x35d59b);//线条填充颜色（选择）
        
        config.strokeColorIncorrect = RGBFormUIColor(0xfdddd6);//圆弧的填充颜色（错误）
        config.fillColorIncorrect = RGBFormUIColor(0xfdddd6);//除中心圆点外 其他部分的填充色（错误）
        config.centerPointColorIncorrect = RGBFormUIColor(0xf75730);//中心圆点的颜色（错误）
        config.lineColorIncorrect = RGBFormUIColor(0xf75730);//线条填充颜色（错误）
